...
После этого git ,будет игнорировать файлы находящиеся в папке `.gitignore`
 ...
 4.  На своём компьютере в терминале вводим команду `cd название клонированного репозитория/название папки где должен быть склонированный репозиторий`. Данной командой мы меняем директории с GitHub на директорию ранеесозданной папки.Тем самым создаём в папке репозиторий.
